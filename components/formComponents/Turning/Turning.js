  ...
  return (
    <View style={styles.modalItem}>
      <View style={styles.activitySwitch}>
        <Text style={styles.activityTitle}>Obracanie doniczki</Text>
        <CustSwitch
      ...
      {props.isTurning && (
        <View>
          <View style={styles.modalRow}>
            <Text style={[styles.modalText]}>Częstotliwość obracania</Text>
            <Picker
              ref={pickerRef}
          ...
          <View style={styles.rowTimePicker}>
            <Text style={[styles.modalText]}>Godzina powiadomienia</Text>
            <CustTimePicker
              time={true}
          ...
          <View style={styles.rowTimePicker}>
            <Text style={[styles.modalText]}>Pierwsze powiadomienie</Text>
            <CustTimePicker
              time={false}
